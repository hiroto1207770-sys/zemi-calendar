...
4. Set script properties `GEMINI_KEY`, `SPREADSHEET_ID`, `ADMIN_NAME`, and optionally `GEMINI_MODEL` (`gemini-3.5-flash-lite` by default).
5. Redeploy the existing web-app deployment or create a replacement and update `DEFAULT_URL` in `index.html`.
